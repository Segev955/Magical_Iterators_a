...
TEST_CASE("init") {
    ...
    CHECK_NOTHROW(SideCrossIterator sidIter(container));
    CHECK_NOTHROW(PrimeIterator priIter(container));
}
...
TEST_CASE("AscendingIterator") {
    ...
    container.addElement(1);
    container.addElement(9);
    AscendingIterator ascIter(container); // 1 9 24
...
TEST_CASE("SideCrossIterator") {
    ...
    container.addElement(1);
    container.addElement(9);
    SideCrossIterator sidIter(container); // 24 9 1
...
TEST_CASE("PrimeIterator") {
    ...
    container.addElement(9);
    PrimeIterator primIter(container); // 1 7
